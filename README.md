...
| 🎨 **AI 文生图** | 集成通义万相/豆包/DALL-E 3/Gemini Imagen，直连 AI 提供商，隐私安全 |
...
| 🖼️ **AI 文生图** | 通义万相、豆包、DALL-E 3、Gemini Imagen |
...
Phase 9 🔲  → MCP/Skill V2 适配 + 多语言 + 模板市场
```
...
| 🎨 **AI Image Generation** | Tongyi Wanxiang / Doubao / DALL-E 3 / Gemini Imagen — direct API connection, privacy-safe |
